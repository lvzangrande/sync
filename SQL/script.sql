...
VALUES
('techsolutions_cliente.png', 'TechSolutions Indústria LTDA', 'contato@techsolutions.com', 'hash_senha_123', '(11) 98765-4321', '55.666.777/0001-88', 'PJ', 'cliente', NULL, NULL, NULL, NULL, 5, '2021-04-12'),

('maria_admin.png', 'Maria Oliveira (Admin)', 'admin@empresa.com.br', 'hash_senha_admin', '(11) 90000-0000', '00.111.222/0001-33', 'PJ', 'admin', NULL, NULL, NULL, NULL, NULL, '2020-01-15'),

('carlos_profissional.png', 'Carlos Almeida Motores', 'carlos.motores@email.com', 'hash_senha_456', '(11) 91111-1111', '444.555.666-77', 'PF', 'profissional', 'Manutenção Preventiva', 'Disponível', 250.00, 'Especialista em reparo, retífica e manutenção preventiva de motores elétricos e a combustão.', 5, '2023-08-24'),

('ana_profissional.png', 'Ana Costa Pneumática', 'ana.pneumatica@email.com', 'hash_senha_789', '(11) 92222-2222', '777.888.999-00', 'PF', 'profissional', 'Sistemas Hidráulicos', 'Em Atendimento', 300.00, 'Manutenção e calibração de compressores de ar, válvulas e redes pneumáticas industriais.', 4, '2022-11-02'),

('marcos_profissional.png', 'Marcos Ribeiro Hidráulica', 'marcos.hidraulica@email.com', 'hash_senha_101', '(11) 93333-3333', '222.333.444-55', 'PF', 'profissional', 'Equipamentos Industriais', 'Disponível', 400.00, 'Especialista no reparo de bombas, cilindros e unidades hidráulicas de alta pressão.', 5, '2020-07-19'),

('ricardo_profissional.png', 'Ricardo Souza Equipamentos', 'ricardo.equipamentos@email.com', 'hash_senha_202', '(11) 94444-4444', '555.666.777-88', 'PF', 'profissional', 'Sistemas Pneumáticos', 'Inativo', 450.00, 'Manutenção corretiva e preventiva em esteiras, tornos CNC e maquinário pesado em geral.', 3, '2025-03-14'),

('fernando_automacao.jpg', 'Fernando Lima Automação', 'fernando.automacao@email.com', 'hash_senha_303', '(11) 95555-1111', '111.222.333-44', 'PF', 'profissional', 'Manutenção de Motores', 'Disponível', 550.00, 'Projetos e manutenção de CLPs, sensores e sistemas automatizados.', 5, '2024-01-30'),

('juliana_robotica.jpg', 'Juliana Mendes Robótica', 'juliana.robotica@email.com', 'hash_senha_304', '(11) 95555-2222', '222.333.444-66', 'PF', 'profissional', 'Manutenção Preventiva', 'Em Atendimento', 650.00, 'Integração e manutenção de células robotizadas industriais.', 5, '2023-05-17'),

('paulo_eletrica.jpg', 'Paulo Henrique Elétrica', 'paulo.eletrica@email.com', 'hash_senha_305', '(11) 95555-3333', '333.444.555-77', 'PF', 'profissional', 'Sistemas Pneumáticos', 'Disponível', 380.00, 'Instalação e manutenção de painéis elétricos industriais.', 4, '2021-12-05'),

('rodrigo_cnc.jpg', 'Rodrigo Martins CNC', 'rodrigo.cnc@email.com', 'hash_senha_306', '(11) 95555-4444', '444.555.666-99', 'PF', 'profissional', 'Equipamentos Industriais', 'Disponível', 700.00, 'Programação e manutenção de centros de usinagem CNC.', 5, '2025-10-11'),

('beatriz_instrumentacao.jpg', 'Beatriz Santos Instrumentação', 'beatriz.instrumentacao@email.com', 'hash_senha_307', '(11) 95555-5555', '555.666.777-11', 'PF', 'profissional', 'Sistemas Hidráulicos', 'Em Atendimento', 480.00, 'Calibração e manutenção de instrumentos de medição industrial.', 4, '2022-04-29'),

('gabriel_mecatronica.jpg', 'Gabriel Rocha Mecatrônica', 'gabriel.mecatronica@email.com', 'hash_senha_308', '(11) 95555-6666', '666.777.888-22', 'PF', 'profissional', 'Manutenção de Motores', 'Disponível', 520.00, 'Manutenção integrada de sistemas mecânicos, elétricos e eletrônicos.', 5, '2026-02-03'),

('metalurgica_abc.png', 'Metalúrgica ABC LTDA', 'contato@metalurgicaabc.com.br', 'hash_senha_401', '(11) 98888-1111', '12.345.678/0001-90', 'PJ', 'cliente', NULL, NULL, NULL, NULL, 4, '2024-09-18'),

('industria_novaera.png', 'Indústria Nova Era LTDA', 'contato@novaera.com.br', 'hash_senha_402', '(11) 98888-2222', '98.765.432/0001-10', 'PJ', 'cliente', NULL, NULL, NULL, NULL, 5, '2026-06-02');
